...
HD_PWD='C:/Users/ASUS/Desktop/MUX4T1_5/MUX4T1_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MUX4T1_5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MUX4T1_5.tcl
