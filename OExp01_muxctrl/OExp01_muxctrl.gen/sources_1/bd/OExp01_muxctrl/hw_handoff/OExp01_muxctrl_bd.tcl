...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net MUX2T1_5_0_o [get_bd_pins MUX2T1_5_0/o] [get_bd_pins xlslice_0/Din]
  connect_bd_net -net MUX2T1_5_1_o [get_bd_pins MUX2T1_5_1/o] [get_bd_pins xlslice_1/Din]
  ...
  connect_bd_net -net s_0_1 [get_bd_ports s1] [get_bd_pins MUX2T1_5_1/s]
  connect_bd_net -net s_0_2 [get_bd_ports s] [get_bd_pins MUX4T1_5_1/s]
  connect_bd_net -net s_0_3 [get_bd_ports s2] [get_bd_pins MUX8T1_8_0/s]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins MUX8T1_8_0/I1] [get_bd_pins xlconcat_0/dout] [get_bd_pins xlslice_3/Din]
  connect_bd_net -net xlconcat_1_dout [get_bd_pins MUX8T1_8_0/I0] [get_bd_pins xlconcat_1/dout]
  ...
  connect_bd_net -net xlconstant_3_dout [get_bd_pins MUX2T1_5_0/s] [get_bd_pins xlconstant_3/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins xlconcat_0/In0] [get_bd_pins xlconcat_1/In0] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins xlconcat_0/In1] [get_bd_pins xlconcat_1/In1] [get_bd_pins xlslice_1/Dout]
