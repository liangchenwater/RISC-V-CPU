...
set rc [catch {
  ...
  set_property ip_repo_paths c:/archlabs/lab05/lab05.cache/ip [current_project]
  set_property ip_output_repo c:/archlabs/lab05/lab05.cache/ip [current_project]
  add_files -quiet C:/archlabs/lab05/lab05.runs/synth_1/mips_top.dcp
...
set rc [catch {
  ...
  if { [file exists C:/archlabs/lab05/lab05.runs/synth_1/mips_top.hwdef] } {
    catch { write_sysdef -hwdef C:/archlabs/lab05/lab05.runs/synth_1/mips_top.hwdef -bitfile mips_top.bit -meminfo mips_top.mmi -file mips_top.sysdef }
  }
