...
set rc [catch {
  ...
  set_property webtalk.parent_dir C:/archlabs/lab04/lab04.cache/wt [current_project]
  set_property parent.project_path C:/archlabs/lab04/lab04.xpr [current_project]
  set_property ip_repo_paths c:/archlabs/lab04/lab04.cache/ip [current_project]
  set_property ip_output_repo c:/archlabs/lab04/lab04.cache/ip [current_project]
  add_files -quiet C:/archlabs/lab04/lab04.runs/synth_1/mips_top.dcp
  read_xdc C:/archlabs/lab04/lab04.srcs/constrs_1/imports/constrs/sword4.xdc
...
set rc [catch {
  ...
  if { [file exists C:/archlabs/lab04/lab04.runs/synth_1/mips_top.hwdef] } {
    catch { write_sysdef -hwdef C:/archlabs/lab04/lab04.runs/synth_1/mips_top.hwdef -bitfile mips_top.bit -meminfo mips_top.mmi -file mips_top.sysdef }
  }
