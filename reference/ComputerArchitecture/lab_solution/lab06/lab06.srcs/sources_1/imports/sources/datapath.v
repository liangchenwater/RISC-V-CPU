...
module datapath (
	...
	output reg wb_valid,
	// CP0 signals
	output wire [4:0] cp0_addr,  // address of CP0
	output wire [31:0] cp0_dout,  // data writing to CP0
	input wire [31:0] cp0_din,  // data read from CP0
	output wire [31:0] ret_addr,  // target instruction address to store when interrupt occurred
	input wire jump_en,  // force jump enable signal when interrupt authorised or ERET occurred
	input wire [31:0] jump_addr  // target instruction address to jump to
	);
