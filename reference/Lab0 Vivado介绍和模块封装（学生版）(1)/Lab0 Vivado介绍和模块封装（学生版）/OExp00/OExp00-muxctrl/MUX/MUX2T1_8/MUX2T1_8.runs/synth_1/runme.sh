...
HD_PWD='C:/Users/ASUS/Desktop/MUX2T1_8/MUX2T1_8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MUX2T1_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MUX2T1_8.tcl
