...
HD_PWD='C:/Users/liang/Desktop/OrgLab/lab05/piCPU/piCPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pCPU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pCPU.tcl
