...
HD_PWD='C:/Users/liang/Desktop/OrgLab/lab1/stateMachine/stateMachine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seq.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seq.tcl
