...
HD_PWD='C:/Users/liang/Desktop/OrgLab/lab1/ALU/ALU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU_wrapper.tcl
