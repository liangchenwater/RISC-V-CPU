...
HD_PWD='C:/Users/liang/Desktop/OrgLab/lab4/REG32/REG32.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log REG32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source REG32.tcl
