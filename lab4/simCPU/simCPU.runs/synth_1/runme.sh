...
HD_PWD='C:/Users/liang/Desktop/OrgLab/lab4/simCPU/simCPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simCPU_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simCPU_wrapper.tcl
