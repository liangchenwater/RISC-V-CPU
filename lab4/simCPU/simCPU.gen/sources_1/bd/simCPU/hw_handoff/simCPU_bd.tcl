...
################################################################
# This is a generated script based on design: simCPU
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set INT0 [ create_bd_port -dir I INT0 ]
  ...
  connect_bd_net -net INT0 [get_bd_ports INT0] [get_bd_pins SCPUC_0/INT0]
  connect_bd_net -net RAM_B_0_douta [get_bd_pins RAM_B_0/douta] [get_bd_pins SCPUC_0/Data_in]
  connect_bd_net -net SCPUC_0_Addr_out [get_bd_pins SCPUC_0/Addr_out] [get_bd_pins addr11_2/Din]
  connect_bd_net -net SCPUC_0_CPU_MIO [get_bd_pins SCPUC_0/CPU_MIO] [get_bd_pins SCPUC_0/MIO_ready]
  connect_bd_net -net SCPUC_0_Data_out [get_bd_pins RAM_B_0/dina] [get_bd_pins SCPUC_0/Data_out]
  connect_bd_net -net SCPUC_0_MemRW [get_bd_pins RAM_B_0/wea] [get_bd_pins SCPUC_0/MemRW]
  connect_bd_net -net SCPUC_0_PC_out [get_bd_pins SCPUC_0/PC_out] [get_bd_pins pc11_2/Din]
  connect_bd_net -net addr11_2_Dout [get_bd_pins RAM_B_0/addra] [get_bd_pins addr11_2/Dout]
  connect_bd_net -net clk [get_bd_ports clk] [get_bd_pins SCPUC_0/clk] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net dist_mem_gen_0_spo [get_bd_pins ROM/spo] [get_bd_pins SCPUC_0/Inst_in]
  connect_bd_net -net pc11_2_Dout [get_bd_pins ROM/a] [get_bd_pins pc11_2/Dout]
  connect_bd_net -net rst_0_1 [get_bd_ports rst] [get_bd_pins SCPUC_0/rst]
