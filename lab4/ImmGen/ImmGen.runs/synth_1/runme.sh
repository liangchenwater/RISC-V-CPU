...
HD_PWD='C:/Users/liang/Desktop/OrgLab/lab4/ImmGen/ImmGen.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ImmGen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ImmGen.tcl
