...
HD_PWD='C:/Users/liang/Desktop/OrgLab/lab4/SOC/SOC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CSSTE_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CSSTE_wrapper.tcl
