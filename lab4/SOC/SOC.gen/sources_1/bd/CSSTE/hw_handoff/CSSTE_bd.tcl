...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.coefficient_file {../../../../../../../inter_mem.coe} \
  ...
  # Create instance: VGA_orig_0, and set properties
  set VGA_orig_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:VGA_orig:1.0 VGA_orig_0 ]
  ...
  connect_bd_net -net RAM_B_0_douta [get_bd_pins RAM_B_0/douta] [get_bd_pins SCPUC_0/Data_in] [get_bd_pins U5/data6] [get_bd_pins VGA_orig_0/dmem_o_data]
  connect_bd_net -net RSTN_0_1 [get_bd_ports RSTN] [get_bd_pins U9/RSTN]
  connect_bd_net -net SCPUC_0_Addr_out [get_bd_pins SCPUC_0/Addr_out] [get_bd_pins U4/addr_bus] [get_bd_pins U5/data4] [get_bd_pins VGA_orig_0/alu_res] [get_bd_pins VGA_orig_0/dmem_addr] [get_bd_pins xlslice_0/Din]
  connect_bd_net -net SCPUC_0_Data_out [get_bd_pins RAM_B_0/dina] [get_bd_pins SCPUC_0/Data_out] [get_bd_pins U4/Cpu_data2bus] [get_bd_pins U5/data5] [get_bd_pins VGA_orig_0/dmem_i_data]
  connect_bd_net -net SCPUC_0_PC_out [get_bd_pins PC11_2/Din] [get_bd_pins PC31_2/Din] [get_bd_pins SCPUC_0/PC_out] [get_bd_pins U5/data7] [get_bd_pins VGA_orig_0/pc]
  ...
  connect_bd_net -net U2_spo [get_bd_pins SCPUC_0/Inst_in] [get_bd_pins U2/spo] [get_bd_pins U5/data2] [get_bd_pins VGA_orig_0/inst]
  ...
  connect_bd_net -net U9_BTN_OK [get_bd_pins BTN_OK0/Din] [get_bd_pins U4/BTN] [get_bd_pins U9/BTN_OK] [get_bd_pins xlslice_1/Din]
  ...
  connect_bd_net -net U9_rst [get_bd_pins SCPUC_0/rst] [get_bd_pins U10/rst] [get_bd_pins U4/rst] [get_bd_pins U5/rst] [get_bd_pins U6/rst] [get_bd_pins U7/rst] [get_bd_pins U8/rst] [get_bd_pins U9/rst] [get_bd_pins VGA_orig_0/rst]
  connect_bd_net -net VGA_orig_0_hs [get_bd_ports HSYNC] [get_bd_pins VGA_orig_0/hs]
  connect_bd_net -net VGA_orig_0_vga_b [get_bd_ports Blue] [get_bd_pins VGA_orig_0/vga_b]
  connect_bd_net -net VGA_orig_0_vga_g [get_bd_ports Green] [get_bd_pins VGA_orig_0/vga_g]
  connect_bd_net -net VGA_orig_0_vga_r [get_bd_ports Red] [get_bd_pins VGA_orig_0/vga_r]
  connect_bd_net -net VGA_orig_0_vs [get_bd_ports VSYNC] [get_bd_pins VGA_orig_0/vs]
  ...
  connect_bd_net -net clk_0_1 [get_bd_ports clk_100mhz] [get_bd_pins U4/clk] [get_bd_pins U6/clk] [get_bd_pins U8/clk] [get_bd_pins U9/clk] [get_bd_pins VGA_orig_0/clk_100m]
  connect_bd_net -net div11_Dout [get_bd_pins U10/clk2] [get_bd_pins div11/Dout]
  connect_bd_net -net div1_Dout [get_bd_pins VGA_orig_0/clk_25m] [get_bd_pins div1/Dout]
  ...
  connect_bd_net -net pCPU_0_MemRW_ex [get_bd_pins RAM_B_0/wea] [get_bd_pins SCPUC_0/MemRW] [get_bd_pins U4/mem_w] [get_bd_pins VGA_orig_0/mem_wen]
  ...
  connect_bd_net -net xlslice_1_Dout [get_bd_pins SCPUC_0/INT0] [get_bd_pins xlslice_1/Dout]
