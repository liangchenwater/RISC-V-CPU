...
module CSSTE
  ...
  wire U9_rst;
  wire VGA_orig_0_hs;
  wire [3:0]VGA_orig_0_vga_b;
  wire [3:0]VGA_orig_0_vga_g;
  wire [3:0]VGA_orig_0_vga_r;
  wire VGA_orig_0_vs;
  wire [1:0]b2_0_dout;
  ...
  assign Blue[3:0] = VGA_orig_0_vga_b;
  assign Green[3:0] = VGA_orig_0_vga_g;
  assign HSYNC = VGA_orig_0_hs;
  assign Key_y_0_1 = BTN_y[3:0];
  assign LED_PEN = U7_LED_PEN;
  assign RSTN_0_1 = RSTN;
  assign Red[3:0] = VGA_orig_0_vga_r;
  assign SEG_PEN = U6_SEG_PEN;
  assign SW_0_1 = SW[15:0];
  assign VSYNC = VGA_orig_0_vs;
  ...
  CSSTE_Multi_8CH32_0_0 U5
       (.Data0(U4_Peripheral_in),
        ...
        .data4(SCPUC_0_Addr_out),
        .data5(SCPUC_0_Data_out),
        .data6(RAM_B_0_douta),
        .data7(SCPUC_0_PC_out),
  ...
  CSSTE_SAnti_jitter_0_0 U9
       (.BTN_OK(U9_BTN_OK),
        ...
        .readn(1'b0),
        .rst(U9_rst));
  CSSTE_VGA_orig_0_0 VGA_orig_0
       (.alu_res(SCPUC_0_Addr_out),
        .clk_100m(clk_0_1),
        .clk_25m(div1_Dout),
        .dmem_addr(SCPUC_0_Addr_out),
        .dmem_i_data(SCPUC_0_Data_out),
        .dmem_o_data(RAM_B_0_douta),
        .hs(VGA_orig_0_hs),
        .inst(U2_spo),
        .mem_wen(pCPU_0_MemRW_ex),
        .pc(SCPUC_0_PC_out),
        .rst(U9_rst),
        .vga_b(VGA_orig_0_vga_b),
        .vga_g(VGA_orig_0_vga_g),
        .vga_r(VGA_orig_0_vga_r),
        .vs(VGA_orig_0_vs));
