...
HD_PWD='C:/Users/liang/Desktop/OrgLab/lab4/CPUC/CPUC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SCPUC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SCPUC.tcl
