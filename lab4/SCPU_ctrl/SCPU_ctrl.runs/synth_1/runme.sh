...
HD_PWD='C:/Users/liang/Desktop/OrgLab/lab4/SCPU_ctrl/SCPU_ctrl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SCPU_ctrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SCPU_ctrl.tcl
